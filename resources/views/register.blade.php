            ...
            <form action="">
                    ...
                    <div class="field-row">
                        <div class="field" id="field_regis_fullname">
                            ...
                            <div class="input">
                                ...
                                <input placeholder="Enter Full Name" name="fullname" id="input_regis_fullname" required class="fira-sans-light color-neon font-regular" type="text">
                            </div>
                        </div>
                        ...
                        <div class="field" id="field_regis_birth">
                            ...
                            <div class="input">
                                ...
                                <input id="input_regis_birth" name="birth" required class="fira-sans-light color-neon font-regular" type="date">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="field-row">
                        <div class="field" id="field_register_email">
                            ...
                            <div class="input">
                                ...
                                <input placeholder="Enter Email" name="email" id="input_register_email" required class="fira-sans-light color-neon font-regular" type="text">
                            </div>
                        </div>
                        ...
                        <div class="field" id="field_regis_line">
                            ...
                            <div class="input">
                                ...
                                <input placeholder="Enter Line ID" name="line_id" id="input_regis_line" required class="fira-sans-light color-neon font-regular" type="text">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="field-row">
                        <div class="field" id="field_register_password">
                            ...
                            <div class="input">
                                ...
                                <input placeholder="Enter Password" name="password" id="input_register_password" required class="fira-sans-light color-neon font-regular" type="password">
                            </div>
                        </div>
                        ...
                        <div class="field" id="field_regis_phone">
                            ...
                            <div class="input">
                                ...
                                <input placeholder="Enter Phone Number" name="phone_number" id="input_regis_phone" required class="fira-sans-light color-neon font-regular" type="text">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="field-row">
                        <div class="field" id="field_register_team">
                            ...
                            <div class="input">
                                ...
                                <input placeholder="Enter Team Name" name="team_name" id="input_register_team" required class="fira-sans-light color-neon font-regular" type="text">
                            </div>
                        </div>
                        ...
                        <div class="field" id="field_regis_comptype">
                            ...
                            <div class="input">
                                ...
                                <select required id="input_register_comptype" class="fira-sans-light color-neon font-regular" name="comp_type">
                ...
                <div class="button-auth">
                    <div id="login" style="width: 100%; margin: auto">
                        <button type="submit" class="button"><h1 class="fira-sans-bold color-dark">Register</h1></button>
                    </div>
